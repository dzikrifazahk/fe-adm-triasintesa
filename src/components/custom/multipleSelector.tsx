    ...
    return (
      ...
      >
        ...
        <div className="relative">
          {open && (
            <CommandList
              className={`absolute top-1 z-10 w-full rounded-md border bg-white text-popover-foreground shadow-md outline-none animate-in ${heightCardBox}`}
              onMouseLeave={() => {
