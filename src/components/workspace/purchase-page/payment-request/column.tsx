...
import { FaEye, FaArrowRotateLeft, FaMoneyBillTransfer } from "react-icons/fa6";
...
type childProps = {
  undoData: (id: string, actionsTitle: "undo") => void;
  viewDetailData: (id: string, actionsTitle: "details") => void;
  payment: (id: string, actionsTitle: "payment") => void;
                ...
                {(cookies.roleId === 1 || cookies.roleId === 2) && (
                  <>
                    <DropdownMenuItem
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        props.payment(data?.doc_no ?? "", "payment");
                      }}
                    >
                    ...
                    <DropdownMenuItem
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        props.undoData(data?.doc_no ?? "", "undo");
                      }}
                    >
                      <FaArrowRotateLeft className="text-red-500" />
                      Undo
                    </DropdownMenuItem>
                  </>
                )}
