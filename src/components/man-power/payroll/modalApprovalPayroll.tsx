...
import { IPayrollApproval } from "@/types/payroll";
...
export default function ModalApprovalPayroll({
  isOpen,
  title,
  onClose,
  id,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload: IPayrollApproval = {
      status: status as TStatus,
      reason_approval: reasonApproval?.trim() ?? undefined,
    };
    ...
    try {
      setIsLoading(true);
      const response = await payrollService.payrollApproval(id, payload);
